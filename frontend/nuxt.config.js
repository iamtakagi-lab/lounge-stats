...
*/
  modules: [
    ...
    ['@nuxtjs/google-adsense', {
      ...
      analyticsDomainName: 'lounge-stats.herokuapp.com'
    }],
    '@nuxtjs/dayjs',
    '@nuxt/content',
    'nuxt-fontawesome'
  ...
  */
  ...
  proxy: { 
    "/api/": { target: process.env.NODE_ENV === 'production' ? 'https://lounge-stats-api.herokuapp.com' : 'http://localhost:8000' } 
   },
