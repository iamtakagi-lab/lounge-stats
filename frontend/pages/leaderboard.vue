<template>
  ...
  <div>
    ...
    <div class="overflow-hidden rounded-lg shadow-lg flex flex-col">
      ...
      <div
        class="overflow-x-auto sticky rounded-lg shadow overflow-y-auto w-full relative dark:border-gray-800 dark:bg-gray-900"
        style="height: 605px"
      >
        <table
          class="border-collapse table-auto w-full whitespace-no-wrap table-striped relative dark:border-gray-800 dark:bg-gray-900"
        >
          <thead>
            <tr class="text-left">
              <th
